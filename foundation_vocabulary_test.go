...
func TestFoundationVocabularyHasOneCanonicalSpelling(t *testing.T) {
	...
	if contexture.PackageName != "contexture" || contexture.Version != "0.16.0rc1" {
		t.Fatalf("root package vocabulary = (%q, %q), want Contexture 0.16 release facts", contexture.PackageName, contexture.Version)
	}
