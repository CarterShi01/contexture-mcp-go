...
func TestDeclarationFacadeInventory(t *testing.T) {
	types := map[string]reflect.Type{
		...
		"DisclosureAPI":             reflect.TypeFor[contexture.DisclosureAPI](),
	...
	values := map[string]any{
		...
		"ErrContexture":                    contexture.ErrContexture,
		"ErrModelValidation":               contexture.ErrModelValidation,
		"ErrDeclaration":                   contexture.ErrDeclaration,
		"ErrDuplicateName":                 contexture.ErrDuplicateName,
		...
		"ErrRootOutsideSelection":          contexture.ErrRootOutsideSelection,
		...
		"NewDisclosureAPI":                 contexture.NewDisclosureAPI,
